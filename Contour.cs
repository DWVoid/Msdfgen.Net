...
public class Contour {
    ...
    public void Bounds(ref double l, ref double b, ref double r, ref double t)
    {
        ...
        {
            edge.Segment.Bounds(ref l, ref b, ref r, ref t);
        }
    }
    ...
    public int Winding(){
        ...
        switch (Edges.Count)
        {
            case 1:
            {
                Vector2 a = Edges[0].Segment.Point(0), b = Edges[0].Segment.Point(1.0/3.0), c = Edges[0].Segment.Point(2.0/3.0);
                total += Shoelace(a, b);
                total += Shoelace(b, c);
                total += Shoelace(c, a);
                break;
            ...
            case 2:
            {
                Vector2 a = Edges[0].Segment.Point(0), b = Edges[0].Segment.Point(.5), c = Edges[1].Segment.Point(0), d = Edges[1].Segment.Point(.5);
                total += Shoelace(a, b);
                total += Shoelace(b, c);
                total += Shoelace(c, d);
                total += Shoelace(d, a);
